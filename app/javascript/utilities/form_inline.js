...
function formInlineHandler(testId) {
  const link = document.querySelector('.form-inline-link[data-test-id="' + testId + '"] .bi')
  ...
  if (formInline.classList.contains('hide')) {
    ...
    link.classList.replace('bi-pencil-square', 'bi-x-circle')
  } else {
    testTitle.classList.remove('hide')
    formInline.classList.add('hide')
    link.classList.replace('bi-x-circle', 'bi-pencil-square')
  }
}
